...
//
#ifndef BOOST_DI_PREPROCESSED_DI_10_20_CPP_11_C_HPP
#define BOOST_DI_PREPROCESSED_DI_10_20_CPP_11_C_HPP
...
template<typename... T_MPL>
struct object
    : scope<scopes::object<> >::bind<T_MPL...>
{ };
...
public:
    ...
    typename T::dependency::expected* allocate(TArgs&&... args) const {
        return new typename T::dependency::given(::std::forward<decltype(args)>(args)...);
    }
    };
